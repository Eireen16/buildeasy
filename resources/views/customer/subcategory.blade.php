...
@section('title', $subCategory->subcategory . ' - ' . $category->category . ' Materials')
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('customer.category', $category->id) }}">{{ $category->category }}</a></li>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        {{ $category->category }} - Showing {{ $materials->total() }} materials from our verified suppliers
                    </p>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        @foreach($category->subCategories->where('id', '!=', $subCategory->id) as $otherSubCategory)
                            <a href="{{ route('customer.subcategory', [$category->id, $otherSubCategory->id]) }}" 
                               class="btn btn-outline-secondary btn-sm">
                                {{ $otherSubCategory->subcategory }}
                                <span class="badge bg-light text-dark ms-1">{{ $otherSubCategory->materials->count() }}</span>
                            </a>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="container mb-4">
                ...
                <div class="collapse" id="filterSection">
                    <div class="card mb-3">
                        <div class="card-body">
                            <form method="GET" action="{{ route('customer.subcategory', [$category->id, $subCategory->id]) }}" class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('customer.subcategory', [$category->id, $subCategory->id]) }}" class="btn btn-secondary">
                            ...
                            <div class="d-flex flex-wrap gap-2 align-items-center">
                                ...
                                @if(request('sustainability_filter'))
                                    <span class="badge bg-info">
                                        ...
                                        @endswitch
                                        <a href="{{ route('customer.subcategory', array_merge([$category->id, $subCategory->id], request()->except('sustainability_filter'))) }}" 
                                ...
                                @if(request('location_filter'))
                                    <span class="badge bg-success">
                                        ...
                                        <a href="{{ route('customer.subcategory', array_merge([$category->id, $subCategory->id], request()->except('location_filter'))) }}" 
                                           class="text-white ms-1 text-decoration-none">×</a>
                                    </span>
                                @endif
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        @if(request('sustainability_filter') || request('location_filter'))
                            <p class="text-muted">No materials available in this subcategory with your current filters. Try <a href="{{ route('customer.subcategory', [$category->id, $subCategory->id]) }}">clearing all filters</a> to see more results.</p>
                        @else
                            <p class="text-muted">No materials are currently available in this subcategory.</p>
                        @endif
                    </div>
                </div>
                @endforelse
