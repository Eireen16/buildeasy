            ...
            <div class="card bg-white shadow-sm p-4 mb-4">
                <div class="text-center mb-4">
                    <div class="mx-auto" style="width: 100px; height: 100px; border-radius: 50%; overflow: hidden; background-color: #f8f9fa; border: 1px solid #dee2e6;">
                        <img src="{{ $customer->profile_picture ?? asset('images/DefaultProfile.png') }}" 
                             alt="Profile Picture" 
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="Name" 
                           value="{{ $customer->name ?? 'Please set up your name' }}" 
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="phoneNumber" 
                           value="{{ $customer->phone ?? 'Please set up your phone number' }}" 
                           {{ isset($editMode) && $editMode ? '' : 'readonly' }}>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="Address" 
                           value="{{ $customer->address ?? 'Please set up your address' }}" 
                           {{ isset($editMode) && $editMode ? '' : 'readonly' }}>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="bankDetails" 
                           value="{{ $customer->bank_details ?? 'Please set up your bank details' }}" 
                           {{ isset($editMode) && $editMode ? '' : 'readonly' }}>
                </div>

                <div class="text-center">
                    <a href="{{ route('customer.profile.edit') }}" class="btn text-white px-4 py-2" style="background-color: #2980b9; border-radius: 4px;">
                        Update Profile
                    </a>
                </div>
            </div>
