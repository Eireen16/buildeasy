...
<div class="container-fluid p-0">
    <div style="background-color: #a8d8e8; padding: 20px 0;">
        <div class="container">
            ...
            <form action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data" class="card bg-white shadow-sm p-4">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="bank_details" id="bank_details" class="form-control"
                           value="{{ old('bank_details', $customer->bank_details) }}">
                </div>
