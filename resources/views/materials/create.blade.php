...
<div class="add-listing py-3 mt-3" style="background-color: #a8d8e8; padding: 20px 0;">
    ...
    <div class="container">
        <h1 class="mb-4" style="color: #2980b9; font-size: 2.5rem; font-weight: bold; font-family: Arial, sans-serif;">Add Listing</h1>
                    ...
                    <div class="card-body">
                        <form action="{{ route('materials.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="rating-container">
                                            @for($i = 5; $i >= 1; $i--)
                                                <input type="radio" id="env_{{ $i }}" name="environmental_impact_rating" value="{{ $i }}" {{ old('environmental_impact_rating') == $i ? 'checked' : '' }} required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="rating-container">
                                            @for($i = 5; $i >= 1; $i--)
                                                <input type="radio" id="carbon_{{ $i }}" name="carbon_footprint_rating" value="{{ $i }}" {{ old('carbon_footprint_rating') == $i ? 'checked' : '' }} required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="rating-container">
                                            @for($i = 5; $i >= 1; $i--)
                                                <input type="radio" id="recycle_{{ $i }}" name="recyclability_rating" value="{{ $i }}" {{ old('recyclability_rating') == $i ? 'checked' : '' }} required>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary btn-lg">Add Material Listing</button>
                            </div>
                        </form>
                    </div>
                </div>
