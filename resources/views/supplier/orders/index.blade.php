    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('supplier.orders.history') }}" class="btn bg-white text-dark btn-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    @if(!in_array($order->order_status, ['completed', 'cancelled']))
                                        <div class="d-flex gap-2 mt-3">
                                            <!-- Status Update Form -->
                                            <form action="{{ route('supplier.orders.updateStatus', $order) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('PUT')
                                                <div class="input-group input-group-sm">
                                                    <select name="status" class="form-select" required>
                                                        ...
                                                        @if($order->delivery_method === 'delivery')
                                                            ...
                                                            @endif
                                                        @else
                                                            @if($order->order_status === 'preparing_to_pickup')
                                            ...
                                            <!-- Cancel Order Button -->
                                            <form action="{{ route('supplier.orders.cancel', $order) }}" method="POST" class="d-inline"
