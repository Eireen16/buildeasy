...
@section('title', $category->category . ' Materials - Supplier')
...
<div class="category-results py-3">
    <div class="container-fluid mt-3" style="background-color: #a8d8e8; padding: 20px 0;">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Your materials in this category - Showing {{ $materials->total() }} materials
                    </p>
                </div>
                <div>
                </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h6 class="mb-3">Browse by Subcategory:</h6>
                    <div class="d-flex flex-wrap gap-2">
                        @foreach($category->subCategories as $subCategory)
                            @php
                                $subCategoryMaterialCount = \App\Models\Material::where('supplier_id', Auth::user()->supplier->id)
                                                                                ->where('sub_category_id', $subCategory->id)
                                                                                ->count();
                            @endphp
                            <a href="{{ route('supplier.subcategory', [$category->id, $subCategory->id]) }}" 
                               class="btn btn-outline-secondary btn-sm">
                                {{ $subCategory->subcategory }}
                                <span class="badge bg-light text-dark ms-1">{{ $subCategoryMaterialCount }}</span>
                            </a>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">You haven't added any materials in this category yet.</p>
